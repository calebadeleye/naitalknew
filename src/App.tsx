...
const emptyWebsiteQuoteForm: WebsiteQuoteFormData = {
  name: "",
  phone: "",
  email: "",
  website_type: "",
...
function validateWebsiteQuoteForm(data: WebsiteQuoteFormData): Partial<Record<keyof WebsiteQuoteFormData, string>> {
...
function WebsiteQuoteFieldError({ id, message }: { id: string; message?: string }) {
...
function WebsiteQuoteLandingHeader({ minimal = false }: { minimal?: boolean }) {
  const [isOpen, setIsOpen] = useState(false);
...
function WebsiteQuoteTrustStrip() {
  return (
...
const websiteQuoteIncludedItems = [
...
function WebsiteQuoteIncludedSection() {
  return (
...
const websiteQuoteRecentWork = [
  { title: "Skinologist", description: "E-commerce skincare store built to showcase products and convert browsers into buyers.", image: "/data/work-skinologist.png" },
  { title: "Caleb Adeleye", description: "A personal portfolio site for a software engineer and founder.", image: "/data/work-caleb-adeleye.png" },
  { title: "Luminary Radio", description: "A media and radio streaming website with live programming and news.", image: "/data/work-luminary-radio.png" },
  { title: "Victor Ademofe", description: "A personal portfolio and personal brand website.", image: "/data/work-victor-ademofe.png" },
  { title: "Luminary Radio Mobile App", description: "A companion mobile app for the radio station's live streaming and programming.", image: "/data/work-luminary-radio-mobile-app.png" },
  { title: "UTME Mobile App", description: "A mobile app built to help students prepare for and track their UTME examination.", image: "/data/work-utme-mobile-app.png" },
];

function WebsiteQuoteRecentWork() {
  return (
...
function WebsiteQuoteWhyChooseUs() {
  return (
...
const websiteQuoteProcessSteps = [
...
function WebsiteQuoteProcessSection() {
  return (
...
function WebsiteQuoteFaqSection() {
  return (
...
function WebsiteQuoteLandingPage() {
  useSeo();
...
type WebsiteQuoteConversionMeta = {
  reference?: string;
  website_type?: string;
  estimated_budget?: string;
  campaign?: string;
...
export default function App() {
  ...
  if (path === "/get-a-website/thank-you") return <WebsiteQuoteThankYouPage />;
  if (path === "/get-a-website") return <WebsiteQuoteLandingPage />;
  return <PublicSite />;
}
